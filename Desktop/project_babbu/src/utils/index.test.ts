...
import { TokenAmount, Token, ChainId, Percent, JSBI } from 'wowdiex-sdk'
...
describe('utils', () => {
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0x2eE9b4E93f2c19C4Bf514b1A96F028bb7B9b22Ff')).toBe('0x2eE9b4E93f2c19C4Bf514b1A96F028bb7B9b22Ff')
      expect(isAddress('0x2eE9b4E93f2c19C4Bf514b1A96F028bb7B9b22Ff')).toBe('0x2eE9b4E93f2c19C4Bf514b1A96F028bb7B9b22Ff')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('f164fc0ec4e93095b804a4795bbe1e041497b92a')).toBe('0x2eE9b4E93f2c19C4Bf514b1A96F028bb7B9b22Ff')
    })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0x2eE9b4E93f2c19C4Bf514b1A96F028bb7B9b22Ff')).toBe('0xf164...b92a')
    })
